  ...
  services.recyclarr = {
    ...
    configuration = {
      sonarr.main-sonarr = {
        ...
        base_url = "http://localhost:${toString config.services.sonarr.settings.server.port}/sonarr";
      ...
      radarr.main-radarr = {
        ...
        base_url = "http://localhost:${toString config.services.radarr.settings.server.port}/radarr";
        delete_old_custom_formats = true;
        replace_existing_custom_formats = true;
        quality_profiles = [
          {
