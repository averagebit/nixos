    ...
    content =
      ...
      */
      ''
        ...
        socks5_proxy_url = ""
        permissions = 770
        download_dir = /media/storage/downloads/usenet/downloading
        download_free = ""
        complete_dir = /media/storage/downloads/usenet/completed
        complete_free = ""
        ...
        dirscan_dir = /media/storage/downloads/usenet/watch
        dirscan_speed = 5
        password_file = ""
